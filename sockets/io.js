...
socketio.init = (function (io) {
    ...
    io.on("connection", function (socket) {
        ...
        socket.on("addVideo", function (data) {
            ...
            var api = "AIzaSyAOoLe8Qf0C_pPYBq5rM6bQICf57yIrFSg"; // todo: put this somewhere else
            ...
            var options = {
                host: 'www.googleapis.com',
                path: '/youtube/v3/videos?id=' + data.url + '&key=' + api + '&part=contentDetails,snippet',
                method: 'GET',
                port: 443
            };
...
var validateUser = (function (username, room_name) {
    ...
    if (username.length > 30 || room_name.length > 24) {
        return false;
    }
    return true;
});
